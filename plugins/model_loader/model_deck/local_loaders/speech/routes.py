...
LOADER_ID = "model_loader.model_deck.speech"
...
def install(app) -> None:
    ...
    if isinstance(reg, dict):
        reg.setdefault(LOADER_ID, type("DeckSpeech", (), {"id": LOADER_ID, "name": "Model Deck Speech (GGUF)", "load": staticmethod(load), "unload": staticmethod(unload)})())
