...
LOADER_ID = "model_loader.model_deck.safety"
...
def install(app) -> None:
    ...
    if isinstance(reg, dict):
        reg.setdefault(LOADER_ID, type("DeckSafety", (), {"id": LOADER_ID, "name": "Model Deck Safety (GGUF)", "load": staticmethod(load), "unload": staticmethod(unload)})())

    r = APIRouter()

    @r.get("/v1/model_loader/model_deck/safety/status")
