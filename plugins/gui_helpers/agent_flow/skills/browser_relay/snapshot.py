...
NAME = "browser_relay.snapshot"
PERMISSIONS = ["browser_relay.snapshot", "browser_relay.*"]
...
TOOL_SPEC = {
    ...
    "label": "Browser Relay: DOM Snapshot",
    "description": "Extract title, URL, visible text summary, forms, buttons, links, and inputs from the current tab.",
