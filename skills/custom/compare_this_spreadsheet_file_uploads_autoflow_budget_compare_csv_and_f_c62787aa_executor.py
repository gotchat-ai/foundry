...
NAME = 'custom.compare_this_spreadsheet_file_uploads_autoflow_budget_compare_csv_and_f_c62787aa_executor'
PERMISSIONS = ['custom.compare_this_spreadsheet_file_uploads_autoflow_budget_compare_csv_and_f_c62787aa_executor', 'custom.*']
...
def run(ctx: Dict[str, Any], params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    mode = _infer_mode(req, {'id': 'custom.compare_this_spreadsheet_file_uploads_autoflow_budget_compare_csv_and_f_c62787aa_executor', 'label': 'compare_this_spreadsheet_file_uploads_autoflow_budget_compare_csv_and_f executor', 'description': 'Generated workflow executor for: Compare this spreadsheet file /uploads/autoflow_budget_compare.csv and flag any department whose February amount changed by more than 10 percent versus January. Return a reviewer-ready markdown table', 'reason': 'Required because the current installed skills do not fully satisfy the request.', 'category': 'custom', 'params_schema': {'type': 'object', 'properties': {'request_text': {'type': 'string'}, 'user_request': {'type': 'string'}, 'request': {'type': 'string'}, 'text': {'type': 'string'}, 'input_path': {'type': 'string'}, 'file_path': {'type': 'string'}, 'path': {'type': 'string'}}, 'additionalProperties': True}, 'metadata': {'executor_mode': 'data_analysis', 'output_mode': 'table_text', 'required_capabilities': [], 'matched_skills': ['sheet.read_large', 'sheet.profile', 'sheet.search', 'sheet.update', 'sheet.export', 'sheet.aggregate'], 'request_excerpt': 'Compare this spreadsheet file /uploads/autoflow_budget_compare.csv and flag any department whose February amount changed by more than 10 percent versus January. Return a reviewer-ready markdown table and short summary.', 'input_contract': ''}, 'implementation_hint': 'data_analysis', 'request_text': 'Compare this spreadsheet file /uploads/autoflow_budget_compare.csv and flag any department whose February amount changed by more than 10 percent versus January. Return a reviewer-ready markdown table and short summary.', 'repair_focus': 'capability_missing:spreadsheet_io', 'previous_source': '', 'previous_path': '', 'previous_hash': '', 'bug_signals': ['capability_missing:spreadsheet_io'], 'failing_requests': ['Compare this spreadsheet file /uploads/autoflow_budget_compare.csv and flag any department whose February amount changed by more than 10 percent versus January. Return a reviewer-ready markdown table and short summary.']})
...
TOOL_SPEC = {'id': 'custom.compare_this_spreadsheet_file_uploads_autoflow_budget_compare_csv_and_f_c62787aa_executor', 'category': 'custom', 'label': 'compare_this_spreadsheet_file_uploads_autoflow_budget_compare_csv_and_f executor', 'description': 'Generated workflow executor for: Compare this spreadsheet file /uploads/autoflow_budget_compare.csv and flag any department whose February amount changed by more than 10 percent versus January. Return a reviewer-ready markdown table', 'permissions': ['custom.compare_this_spreadsheet_file_uploads_autoflow_budget_compare_csv_and_f_c62787aa_executor', 'custom.*'], 'metadata': {'executor_mode': 'data_analysis', 'output_mode': 'table_text', 'required_capabilities': [], 'matched_skills': ['sheet.read_large', 'sheet.profile', 'sheet.search', 'sheet.update', 'sheet.export', 'sheet.aggregate'], 'request_excerpt': 'Compare this spreadsheet file /uploads/autoflow_budget_compare.csv and flag any department whose February amount changed by more than 10 percent versus January. Return a reviewer-ready markdown table and short summary.', 'input_contract': '', 'version': '1.0', 'created_at': '2026-06-23T06:19:33.338337+00:00', 'last_updated': '2026-06-23T06:19:33.338337+00:00', 'dev_status': 'untested'}, 'params_schema': {'type': 'object', 'properties': {'request_text': {'type': 'string'}, 'user_request': {'type': 'string'}, 'request': {'type': 'string'}, 'text': {'type': 'string'}, 'input_path': {'type': 'string'}, 'file_path': {'type': 'string'}, 'path': {'type': 'string'}}, 'additionalProperties': True}}
